...
x_target = x_target.type(torch.float32)
print(x_target)


df = pd.read_csv("review_data.csv")
star_rating_list = df["y"].to_list()
star_rating_list.pop(0)
star_rating_list.pop(362)

y_target = torch.tensor(star_rating_list, dtype = torch.long)
...
loss_history, train_accuracy = train(x_target, y_target, model, criterion, optimizer, 25)
print("손실 추이: ")
for i in loss_history:
    print(i)
print("잘 분류한 정도를 백분율로 나타냄: ")
